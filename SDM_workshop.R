...
bioclim.data <- getData(name = "worldclim",
                        var = "bio",
                        res = 2.5,
                        path = "/Users/Maby/BSC6926/BSC6926")

obs.data <- read.csv(file = "/Users/Maby/BSC6926/BSC6926/SDM_Data.csv")
summary(obs.data)
obs.data <- obs.data[!is.na(obs.data$latitude), ] #getting rid off NAs
summary(obs.data)
...
bil.files <- list.files(path = "/Users/Maby/BSC6926/BSC6926/wc2-5", 
                        pattern = "*.bil$", 
                        full.names = TRUE)
...
kable(group.presence, caption = "**Pseudo-Absent Random Generated Distribution**", digits= 100)
